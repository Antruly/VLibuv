...
enum VTCP_WORKER_STATUS {
  ...
  VTCP_WORKER_STATUS_STARTING = 0x08,  // 启动中
  VTCP_WORKER_STATUS_LISTENING = 0x10,  // 监听中
  VTCP_WORKER_STATUS_CLOSED = 0x20,     // 已关闭

  // 读写状态
  VTCP_WORKER_STATUS_READING = 0x40,  // 可读取数据
  VTCP_WORKER_STATUS_WRITING = 0x80,  // 可写入数据

  // 数据处理状态
  VTCP_WORKER_STATUS_PROCESSING = 0x100,  // 正在处理数据

  // 断线重连状态
  VTCP_WORKER_STATUS_RECONNECTING = 0x200,  // 重新连接中

  VTCP_WORKER_STATUS_CLOSING = 0x400,  // 正在关闭中
